...
const CuadroVacantesSegEspec = ({ programaName = '', vacantesNumber = 0 }) => {
	return (
		<div>
			<p className="mb-4">
				El proceso de admisión a los programas de segunda especialidad
				de la Unidad de Posgrado de la facultad de Ciencias Biológicas
				se desarrolla semestralmente, según cronograma aprobado por el
				VRIP. A continuación, el cuadro de vacantes correspondiente al
				ciclo 2024-I:
			</p>
...
export default CuadroVacantesSegEspec;
