...
const ProcesoEvaluacionSegEspec = () => {
	return (
		<div>
			{/* <p>
			...
			<ol className="pl-3">
				...
				<li>
					Para alcanzar una vacante la nota mínima aprobatoria es
					65.00 puntos de los 100.00 asignados.
				</li>
			</ol>
		</div>
	);
...
export default ProcesoEvaluacionSegEspec;
