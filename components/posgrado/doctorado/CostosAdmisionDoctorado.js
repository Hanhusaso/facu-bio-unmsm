			...
			<div className="mb-4">
				<div className="d-block d-sm-flex justify-content-center mb-3">
					<div className="card costo mb-3 mb-sm-0 mx-0 mx-sm-2">
						<p className="mb-3 title-green">S/. 400.00</p>
						{/* <p className="font-weight-bold mb-3">Código: 102-010</p> */}
						<p className="mb-0">
							<span className="font-weight-bold">Para:</span>{' '}
							Magíster UNMSM, personal administrativo de la UNMSM,
							docente de Universidades Nacionales y Magisterio
							Nacional.
						</p>
					</div>
					<div className="card costo mb-3 mb-sm-0 mx-0 mx-sm-2">
						<p className="mb-3 title-green">S/. 500.00</p>
			...
			<div className="mb-4">
				<div className="table-responsive mb-3">
					<table className="striped m-auto table-cuadro-vacante">
						...
						<tbody>
							<tr>
								<td className="text-center">09702</td>
								<td>Epg-Doctorado-Inscripcion</td>
								<td className="text-center">S/ 400</td>
							</tr>
							<tr>
								<td className="text-center">09703</td>
								<td>Epg-Doctorado-Otros</td>
								<td className="text-center">S/ 500</td>
							</tr>
						</tbody>
					</table>
				</div>
...
export default CostosAdmisionDoctorado;
