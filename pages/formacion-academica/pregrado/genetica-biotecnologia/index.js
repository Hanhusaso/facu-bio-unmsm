        ...
        <>
            <Layout title="Genética y Biotecnología">
                <div>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Breadcrumb>
                                        ...
                                        <Breadcrumb.Item active>E.P Genética y Biotecnología</Breadcrumb.Item>
                                    </Breadcrumb>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                    ...
                    <div>
                        <Container className="mb-3">
                            <Row>
                                <Col md="1"></Col>
                                <Col>
                                    <div className="title-page text-center">E.P Genética y Biotecnología</div>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                        </Container>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/carreras/genetica/banner_genetica.png" alt="" />
                    </div>
                                        ...
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            <div className="wrapper-img-fr">
                                                <div className="img-fr">
                                                    <img className="w-100 img-fluid" src="/assets/img/carreras/genetica/directora.png" alt="" />
                                                    <div className="caption">
                                                        <div className="mb-2 font-weight-bold">Directora</div>
                                                        <div className="mb-1">Mónica Yolanda Paredes Anaya</div>
                                                        <div className="mb-0">mparedesa1@unmsm.edu.pe</div>
                                                    </div>
                                                </div>
                                                <p>
                                                    La Genética y la Biotecnología son especialidades que cada vez cobran mayor importancia en la transformación y el desarrollo de nuestra sociedad. Desde los experimentos de Mendel a mediados del siglo XIX, pasando por el descubrimiento de la doble hélice del ADN a mediados del siglo XX, y el desciframiento del genoma humano a inicios del siglo XXI, los avances y las aplicaciones de las diferentes áreas de la genética, genómica, transcriptómica, y la ingeniería genética han tenido un gran auge lo que actualmente repercute en numerosas actividades humanas.
                                                </p>
                                                <p>
                                                    La posibilidad de estudiar un gen específico o el genoma completo de una especie, utilizando herramientas biotecnológicas, ha permitido lograr grandes avances en el ámbito ambiental, agrícola, ganadero y de salud; incluyendo las áreas de la bioética y el derecho. Por esta razón, la Genética y la Biotecnología se han convertido en especialidades con gran demanda en la sociedad actual.
                                                </p>
                                                <p>
                                                    Es por ello que la EP de Genética y Biotecnología de la Universidad Nacional Mayor de San Marcos los invita a conocer las bases hereditarias de la vida y sus diversos ámbitos de aplicación. Para ello, ofrecemos una formación integral e interdisciplinaria que permita formar profesionales que colaboren con el desarrollo socio económico del país al plantear soluciones a los problemas de nuestra sociedad en el ámbito de su competencia.
                                                </p>
                                                <p>
                                                    El Plan de estudios está diseñado para obtener conocimientos teóricos y prácticos, dentro de una educación por competencias, con la finalidad de formar profesionales líderes, críticos, proactivos con una base científica que les permitan desenvolverse tanto en la empresa pública y/o privada, así como desarrollar investigación básica y/o aplicada, en los campos de la biología, biomedicina, industria farmacéutica, genómica, la mejora genética agropecuaria, la industria alimentaria, la minería entre otros.
                                                </p>
                                                <div>
                                                    <p className="title-dark">Grado:</p>
                                                    <p>Bachiller en Genética y Biotecnología</p>
                                                </div>
                                                <div>
                                                    <p className="title-dark">Título:</p>
                                                    <p>Biólogo Genetista Biotecnólogo</p>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <p>
                                                        Es una persona con sólida formación científica tecnológica, con base humanista y ética, con pensamiento crítico e innovador y responsabilidad social. Se caracteriza por tener una visión crítica, actualizada e innovadora de la ciencia y la tecnología. Es capaz de diseñar, implementar y gestionar proyectos en el campo de su competencia. Tiene la capacidad de integrarse al mercado productivo, participando interdisciplinariamente en la identificación y solución de problemas específicos sobre los recursos genéticos y sus diversos aspectos biotecnológicos, entre otras competencias.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mb-3 tab-pane fade" id="v-pills-mision" role="tabpanel" aria-labelledby="v-pills-mision-tab">
                                            ...
                                            <div className="grid-img-txt-1">
                                                ...
                                                <div className="mb-3 mb-md-0">
                                                    ...
                                                    <p className="mb-0">
                                                        Ser referente nacional e internacional en la formación de profesionales líderes en el área de Genética y Biotecnología, con excelencia académica y de investigación, comprometidos con el desarrollo sostenible del país.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
