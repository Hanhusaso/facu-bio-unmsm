        ...
        <>
            <Layout title="Microbiología y Parasitología">
                <div>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/carreras/microbiologia/banner_microbiologia.png" alt="" />
                    </div>
                                ...
                                <Col md="3" lg="2">
                                    <div className="mb-4">
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a href="https://drive.google.com/drive/folders/14oNAoApmIednms1n7KitzJJnNqE9hAdi?usp=sharing" target="_blank" className="tab d-flex">
                                                    <div>
                                    ...
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            <div className="wrapper-img-fr">
                                                <div className="img-fr">
                                                    <img className="w-100 img-fluid" src="/assets/img/carreras/microbiologia/director.png" alt="" />
                                                    <div className="caption">
                                                        <div className="mb-2 font-weight-bold">Director</div>
                                                        <div className="mb-1">Pedro Luis Castellanos Sánchez</div>
                                                        <div className="mb-0">pcastellanos@unmsm.edu.pe</div>
                                                    </div>
                                                </div>
                                                <p>
                                                    Hacia el último tercio del siglo XX las ciencias biológicas experimentaron vertiginosos cambios caracterizados por la alta especialización y la aparición de nuevos campos de investigación. Docentes y estudiantes del Programa Académico de Ciencias Biológicas no estuvieron ajenos a estos cambios y concibieron la necesidad de diversificar las áreas de formación profesional de manera que permitieran atender la demanda creciente de Biólogos especializados; producto de este esfuerzo se crearon las menciones de Biología Celular y Genética, Botánica, Hidrobiología y Pesquería, Microbiología y Parasitología y Zoología en 1973.
                                                </p>
                                                <p>
                                                    Con el transcurrir del tiempo la demanda de profesionales competentes en áreas profesionales específicas se incrementó, especialmente en el área de la microbiología y parasitología donde los Biólogos con orientación fueron abriendo campos ocupacionales.
                                                </p>
                                                <p>
                                                    La demanda de Biólogos Microbiólogos Parasitólogos sigue creciendo, no sólo ejercen sus funciones en nuestro país, sino también en otros países del mundo como consecuencia de la globalización. Por ello los docentes del Departamento Académico de Microbiología y Parasitología y los estudiantes de la Facultad de Ciencias Biológicas gestionaron la creación de un organismo académico-profesional para la formación de especialistas en el área.
                                                </p>
                                                <p>
                                                    En Julio de 2002 la Asamblea Universitaria ratifica la creación de la Escuela Académico Profesional de Microbiología y Parasitología de la UNMSM, mediante Resolución Rectoral N.º 04942-R-02, recibiendo ésta a sus primeros alumnos en el año 2003. En el 2005 se aprueba el Plan Curricular definitivo, llamado también Plan Curricular 2003 (aprobado con RR. N.º 01249-R-05 del 10 de marzo de 2005), que ha venido sosteniendo la formación de los alumnos de las primeras 5 promociones de la Escuela. ÁMBITO LABORAL: Existe gran demanda de Microbiólogos-Parasitólogos en determinados sectores de la actividad nacional como salud, agricultura y alimentación, medio ambiente e industria. Entre ellos tenemos: Direcciones de Salud a nivel nacional, Dirección General de Saneamiento Ambiental y la Dirección General de Medicamentos y Drogas del Ministerio de Salud. Empresas fabricantes de productos alimenticios que requieren de inspecciones higiénico-sanitarias y análisis microbianos permanentes. Gerencias municipales de saneamiento ambiental, control de alimentos y aguas y de educación sanitaria de las Municipalidades a nivel regional y nacional. Empresas agrícolas y agroindustriales que requieren de una permanente evaluación de la contaminación microbiana en sus procesos de producción. Docencia en Instituciones de Educación Superior: universidades públicas o privadas e Institutos Superiores Tecnológicos. Investigación en Centros de producción y laboratorios especializados. Promotores de empresas biotransformadoras.
                                                </p>
                                                <div>
                                                    <p className="title-dark">Grado:</p>
                                                    <p>Bachiller en Microbiología y Parasitología</p>
                                                </div>
                                                <div>
                                                    <p className="title-dark">Título:</p>
                                                    <p>Título Profesional de Biólogo Microbiólogo Parasitólogo</p>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    <p>
                                                        El egresado de la Escuela Académico-Profesional de Microbiología y Parasitología de la Facultad de Ciencias Biológicas de la UNMSM al término de sus estudios será competente de: Diseñar, dirigir y ejecutar programas o actividades de aislamiento e identificación de microorganismos, parásitos y artrópodos a partir de seres humanos, animales y plantas; así como del suelo, aguas, aire y de productos elaborados por el ser humano.
                                                    </p>
                                                    <p>
                                                        Diseñar, dirigir y ejecutar programas de detección, prevención y control de microorganismos, parásitos y artrópodos que puedan afectar a los seres vivos o a productos útiles para el ser humano. Evaluar y calificar el estado higiénico-sanitario de ambientes, aguas, suelos y aire, y establecer medidas de prevención, control y corrección cuando se juzguen necesarios.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="mb-3 tab-pane fade" id="v-pills-mision" role="tabpanel" aria-labelledby="v-pills-mision-tab">
                                            <div className="grid-img-txt-1">
                                                <div>
                                                    <img className="w-100 img-fluid" src="/assets/img/carreras/microbiologia/mision-ep-microbiologia-parasitologia-ciencias-biologicas-unmsm.png" alt="" />
                                                </div>
                                                <div className="mb-3 mb-md-0">
                                                    <p className="title">Misión</p>
                                                    <p className="mb-0">
                                                        Somos profesionales biólogos microbiólogos parasitólogos, generadores y difusores de conocimientos científicos y tecnológicos, con pensamiento crítico y capacidad de gestión. Nuestra labor contribuye a solucionar, en el campo de nuestra diversidad biológica, las necesidades y al desarrollo sostenible del país.
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid-img-txt-1">
                                                <div>
                                                    <img className="w-100 img-fluid" src="/assets/img/carreras/microbiologia/vision-ep-microbiologia-parasitologia-ciencias-biologicas-unmsm.png" alt="" />
                                                </div>
                                                <div className="mb-3 mb-md-0">
                                                    <p className="title">Visión</p>
                                                    <p className="mb-0">
                                                        Ser una Escuela Profesional de microbiología y parasitología, líder a nivel nacional e internacional, capaz de gerenciar proyectos para contribuir a la solución de problemas del país, generadores de conocimiento y de educación de calidad.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
