                                        ...
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            <div className="wrapper-img-fr">
                                                ...
                                                <div>
                                                    ...
                                                    <p>
                                                        El egresado estará preparado en las siguientes competencias: Diseñar, dirigir y ejecutar programas o actividades de aislamiento e identificación de microorganismos, parásitos y artrópodos a partir de seres humanos, animales y plantas; así como del suelo, agua, aire y de productos elaborados por el ser humano. Es capaz de diseñar, dirigir y ejecutar programas de detección, prevención y control de microorganismos, parásitos y artrópodos que puedan afectar a los seres vivos o a productos útiles para el ser humano. Evalúa y califica el estado higiénico-sanitario de ambientes, aguas, suelos y aire, y establecer medidas de prevención, control y corrección cuando se juzguen necesarios, entre otras competencias.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
