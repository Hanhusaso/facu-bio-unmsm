...
const mencionTaxonomiaYSistematicaEvolutiva = () => {
	const asignaturas_obligatorias = planEstudios.filter(
		(plan) =>
			plan.program_name ===
				'maestria-en-botanica-tropical-con-mencion-en-taxonomia-y-sistematica-evolutiva' &&
	...
	return (
		<>
			<Layout title="Maestría en Botánica Tropical con mención en Taxonomía y Sistemática Evolutiva">
				<div>
					<div>
						<Container>
							<Row>
								...
								<Col>
									<Breadcrumb>
										...
										<Breadcrumb.Item active>
											...
											mención en Taxonomía y Sistemática
											Evolutiva
										</Breadcrumb.Item>
									</Breadcrumb>
								</Col>
									...
									>
										...
										>
											<PlanDeEstudio
												...
												plan_estudio="https://biologia-unmsm.s3.us-east-2.amazonaws.com/plan-estudio/Plan+estudios+BT+con+menci%C3%B3n+en+Taxonom%C3%ADa+y+Sistem%C3%A1tica+Evolutiva.pdf"
											/>
										</div>
									</div>
									{width < 768 && (
...
export default mencionTaxonomiaYSistematicaEvolutiva;
