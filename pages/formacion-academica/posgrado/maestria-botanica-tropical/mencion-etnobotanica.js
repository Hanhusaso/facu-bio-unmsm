...
const mencionEtnobotanica = () => {
	const asignaturas_obligatorias = planEstudios.filter(
		(plan) =>
			plan.program_name ===
				'maestria-en-botanica-tropical-con-mencion-en-etnobotanica' &&
	...
	return (
		<>
			<Layout title="Maestría en Botánica Tropical con mención en Etnobotánica">
				<div>
					<div>
						<Container>
							<Row>
									...
									>
										...
										>
											...
											<p className="mb-4">
												...
												revalorizar las plantas
												utilizadas por civilizaciones y
												culturas antiguas, especialmente
												flora americana y peruana, con
												el fin de conservar el
												conocimiento ancestral y su
												protección.
											</p>
											<p className="mb-3">
											...
											<p className="mb-4">
												...
												flora utilizada por las antiguas
												culturas y las presentes, con la
												finalidad de marcar un
												precedente para las bases de su
											...
											>
												...
												>
													<CuadroVacantesMaestria
														programaName="Botánica Tropical con mención en Etnobotánica"
														vacantesNumber={14}
													/>
												</Tab>
												<Tab
...
export default mencionEtnobotanica;
