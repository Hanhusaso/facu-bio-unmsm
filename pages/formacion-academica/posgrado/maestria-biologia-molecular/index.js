...
const index = () => {
    ...
    useEffect(() => {
        (async () => {
          const response = await getDocenteByIdInformacionAcademicaApi("maestria_en_biologia_molecular");
        ...
        <>
            <Layout title="Maestría en Biología Molecular">
                <div>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Breadcrumb>
                                        ...
                                        <Breadcrumb.Item active>Maestría en Biología Molecular</Breadcrumb.Item>
                                    </Breadcrumb>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                    ...
                    <div>
                        <Container className="mb-3">
                            <Row>
                                <Col md="1"></Col>
                                <Col>
                                    <div className="title-page text-center">Maestría en Biología Molecular</div>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                        </Container>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/posgrado/maestria biologia molecular/banner-maestria-biologia-molecular-unmsm.png" alt="" />
                    </div>
                                    ...
                                    <div className="mb-4">
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a className="tab d-flex" id="v-pills-admision-tab" data-toggle="pill" href="#v-pills-admision" role="tab" aria-controls="v-pills-admision" aria-selected="false">
                                                    <div>
                                                        <svg width="23" height="18" viewBox="0 0 23 18" className="icon mr-3" xmlns="http://www.w3.org/2000/svg">
                                                        <g clip-path="url(#clip0)">
                                                        ...
                                                        <defs>
                                                        <clipPath id="clip0">
                                                        <rect width="21.9521" height="16.6094" fill="white" transform="translate(0.34375 0.682373)"/>
                                                        </clipPath>
                                                        </defs>
                                                        </svg>
                                                    </div>
                                                ...
                                                <a className="tab d-flex" id="v-pills-docente-tab" data-toggle="pill" href="#v-pills-docente" role="tab" aria-controls="v-pills-docente" aria-selected="false">
                                                    <div>
                                                        <svg width="24" height="20" viewBox="0 0 24 20" className="icon mr-3" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a href="/assets/archivos/posgrado/planes de estudio/plan-estudio-2020-maestria-biologia-molecular.pdf" target="_blank" className="tab d-flex">
                                                    <div>
                                ...
                                <Col md="7" lg="8">
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            ...
                                            <p>
                                                El programa forma investigadores de alto nivel científico que comprendan y apliquen los conceptos actuales de la Biología Molecular en arqueas, eucariotes y bacterias, cubriendo fundamentalmente las áreas básicas y aplicadas, incluyendo los aspectos genéticos, bioquímicos, fisiológicos, taxonómicos y evolutivos, para el aprovechamiento racional de nuestra enorme biodiversidad.
                                            </p>
                                            ...
                                            <p>
                                                Profesionales que posean el grado académico de bachiller en Ciencias Biológicas, Genética, Microbiología, Química, Medicina Humana, Medicina Veterinaria, Odontología, Agronomía, Biotecnología, Nutrición y Farmacia y Bioquímica; asimismo, deberán acreditar haber aprobado durante sus estudios de pregrado los siguientes cursos o sus equivalentes: Bioquímica, Genética Microbiana, Animal o Humana y Fisiología General; y contar con una línea de investigación.
                                            </p>
                                            ...
                                            <ul className="chevron-green-dark">
                                                <li>
                                                    El graduado de la maestría de Biología Molecular será un profundo conocedor de los conceptos y metodologías actualizadas en el campo de la biología molecular, además de constituirse en un seguidor activo de los constantes avances de la disciplina.
                                                </li>
                                                <li>
                                                    Demostrará capacidad y autonomía en la formulación, gestión de proyectos de investigación en Biología Molecular y será capaz de trabajar en equipo y redes en forma interdisciplinaria.
                                                </li>
                                                <li>
                                                    Presentará una actitud comprometida con la actualización permanente y con el desarrollo de la biología molecular en su quehacer profesional, en la docencia y en la investigación.
                                                </li>
                                                <li>
                                                    Líder de la investigación básica y/o aplicada que podrá dirigir investigaciones inter, multi y transdisciplinarias.
                                                </li>
                                                <li>
                                                    Es capaz de analizar problemas y establecer preguntas relevantes a nivel celular y molecular.
                                                </li>
                                                <li>
                                                    Es autónomo con principios éticos de investigación, que saben trabajar en equipo, escribir propuestas de proyectos y publicar el producto de su investigación en revistas científicas internacionales.
                                                </li>
                                            </ul>
                                            <div className="mb-3">
                                                ...
                                                <ul className="nav flex-column ml-3">
                                                    <li>Mg. Patricia Woll Toso (Presidente)</li>
                                                    <li>Dr. Dan Erik Vivas Ruiz</li>
                                                    <li>Mg. Erasmo Colona Vallejos</li>
                                                </ul>
                                            </div>
