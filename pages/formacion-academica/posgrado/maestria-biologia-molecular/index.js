								...
								<Col md="7" lg="8">
									<div className="mb-3 tab-content" id="v-pills-tabContent">
										...
										>
											...
											<p>
												La Maestría de Investigación en Biología Molecular forma especialistas del
												más alto nivel conocedores de los conceptos y metodologías actualizadas en
												el campo de la biología molecular, además de constituirse en un seguidor
												activo de los constantes avances de la disciplina.
											</p>

											<p className="title-dark">Grado que se otorga:</p>
											<p>Magíster en Biología Molecular</p>

											<p className="title-dark">Objetivos académicos:</p>
											<p>
												El programa forma investigadores de alto nivel científico que comprendan y
												apliquen los conceptos actuales de la Biología Molecular en arqueas,
												eucariotes y bacterias, cubriendo fundamentalmente las áreas básicas y
												aplicadas, incluyendo los aspectos genéticos, bioquímicos, fisiológicos,
												taxonómicos y evolutivos, para el aprovechamiento racional de nuestra enorme
												biodiversidad.
											</p>

											<p className="title-dark">Dirigido a:</p>
											<p>
												Profesionales que posean el grado académico de bachiller en Ciencias
												Biológicas, Genética, Microbiología, Química, Medicina Humana, Medicina
												Veterinaria, Odontología, Agronomía, Biotecnología, Nutrición y Farmacia y
												Bioquímica; asimismo, deberán acreditar haber aprobado durante sus estudios
												de pregrado los siguientes cursos o sus equivalentes: Bioquímica, Genética
												Microbiana, Animal o Humana y Fisiología General; y contar con una línea de
												investigación.
											</p>
											...
											<ul className="chevron-green-dark">
												<li>
													El graduado de la maestría de Biología Molecular será un profundo
													conocedor de los conceptos y metodologías actualizadas en el campo de la
													biología molecular, además de constituirse en un seguidor activo de los
													constantes avances de la disciplina.
												</li>
												<li>
													Demostrará capacidad y autonomía en la formulación, gestión de proyectos
													de investigación en Biología Molecular y será capaz de trabajar en equipo
													y redes en forma interdisciplinaria.
												</li>
												<li>
													Presentará una actitud comprometida con la actualización permanente y con
													el desarrollo de la biología molecular en su quehacer profesional, en la
													docencia y en la investigación.
												</li>
												<li>
													Líder de la investigación básica y/o aplicada que podrá dirigir
													investigaciones inter, multi y transdisciplinarias.
												</li>
												<li>
													Es capaz de analizar problemas y establecer preguntas relevantes a nivel
													celular y molecular.
												</li>
												<li>
													Es autónomo con principios éticos de investigación, que saben trabajar en
													equipo, escribir propuestas de proyectos y publicar el producto de su
													investigación en revistas científicas internacionales.
												</li>
											</ul>
											<div className="mb-3">
												<p className="title-dark mb-1">Comité coordinador de la Maestría:</p>
