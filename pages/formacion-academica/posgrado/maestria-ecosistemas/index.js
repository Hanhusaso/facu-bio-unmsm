...
const index = () => {
    ...
    useEffect(() => {
        (async () => {
          const response = await getDocenteByIdInformacionAcademicaApi("maestria_en_ecosistemas_y_recursos_acuaticos");
        ...
        <>
            <Layout title="Maestría en Ecosistemas y Recursos Acuáticos">
                <div>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Breadcrumb>
                                        ...
                                        <Breadcrumb.Item active>Maestría en Ecosistemas y Recursos Acuáticos</Breadcrumb.Item>
                                    </Breadcrumb>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                    ...
                    <div>
                        <Container className="mb-3">
                            <Row>
                                <Col md="1"></Col>
                                <Col>
                                    <div className="title-page text-center">Maestría en Ecosistemas y Recursos Acuáticos</div>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                        </Container>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/posgrado/maestria ecosistemas/banner-maestria-ecosistemas-recursos-acuaticos-unmsm.png" alt="" />
                    </div>
                                ...
                                <Col md="3" lg="2">
                                    <div className="mb-4">
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a href="/assets/archivos/posgrado/planes de estudio/plan-estudio-2020-maestria-ecosistemas-recursos-acuaticos.pdf" target="_blank" className="tab d-flex">
                                                    <div>
