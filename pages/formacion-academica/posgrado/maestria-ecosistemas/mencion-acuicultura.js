...
const mencionAcuicultura = () => {
	const asignaturas_obligatorias = planEstudios.filter(
		(plan) =>
			plan.program_name ===
				'maestria-en-ecosistemas-y-recursos-acuaticos-con-mencion-en-acuicultura' &&
	...
	return (
		<>
			<Layout title="Maestría en Ecosistemas y Recursos Acuáticos con mención en Acuicultura">
				<div>
					<div>
						<Container>
							<Row>
									...
									>
										...
										>
											...
											<p className="mb-4">
												...
												la acuicultura de los recursos
											...
											<p className="mb-4">
												...
												originales aplicados a la
												acuicultura sostenible de
												recursos acuáticos. Mejorar el
												nivel académico, técnico y
											...
											<p className="mb-4">
												...
												en Acuicultura aborda temas
												transversales asociados al
										...
										>
											<PlanDeEstudio
												...
												plan_estudio="https://biologia-unmsm.s3.us-east-2.amazonaws.com/plan-estudio/MAESTR%C3%8DA+EN+ECOSISTEMAS+Y+RECURSOS+ACU%C3%81TICOS+CON+MENCI%C3%93N+EN+ACUICULTURA+F+++1++F+.pdf"
											/>
										</div>
									</div>
									{width < 768 && (
...
export default mencionAcuicultura;
