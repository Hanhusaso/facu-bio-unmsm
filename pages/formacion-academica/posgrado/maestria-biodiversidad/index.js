								...
								<Col md="7" lg="8">
									<div className="mb-3 tab-content" id="v-pills-tabContent">
										...
										>
											...
											<p>
												El objetivo general de la Maestría de Investigación en Biodiversidad y
												Gestión de Ecosistemas es formar recursos humanos con la capacidad de
												generar conocimientos. Promover y gestionar la conservación en relación a la
												biodiversidad dentro de los enfoques del desarrollo sustentable y
												Ecosistémico en las distintas regiones del país.
											</p>

											<p className="title-dark">Grado que se otorga:</p>
											<p>Magíster en Biodiversidad y Gestión de Ecosistemas</p>

											<p className="title-dark">Objetivos académicos:</p>
											<p>
												La Universidad Nacional Mayor de San Marcos forma Magísteres en
												Biodiversidad y Gestión de Ecosistemas altamente capacitados para conducir
												actividades o programas sobre biodiversidad y de gestión de ecosistemas a
												nivel de la planificación y ejecución operativa, científica y tecnológica.
												El graduado logrará incrementar su capacidad innovadora y crítica
												desarrollando estrategias de gestión de enfoque ecosistémico y de
												participación integral.
											</p>

											<p className="title-dark">Dirigido a:</p>
											<p>
												Profesionales que estén en posesión del grado académico de Bachiller en
												Ciencias Biológicas, Ciencias Ambientales, Ingeniero Agrónomo, Veterinaria o
												disciplinas afines, otorgados por universidades nacionales o extranjeras que
												quieran asegurar una formación de posgrado en recursos humanos
												especializados en el estudio, gestión y conservación de los recursos
												biológicos del país.
											</p>
											...
											<ul className="chevron-green-dark">
												<li>
													Conocer aspectos tantos teóricos como prácticos de la Diversidad animal y
													de la Diversidad vegetal; y los conocimientos y experiencia necesarios
													para que se incorpore al ámbito laboral.
												</li>
												<li>
													Identificar taxones de animales y vegetales, conocer los fundamentos
													biológicos de la taxonomía y su aplicabilidad a la gestión sostenible de
													ecosistemas terrestres y marinos, la ciencia forestal, la arqueología,
													etc.
												</li>
												<li>
													Tener las habilidades que les permitirán ejercer sus actividades en
													empresas, organizaciones e instituciones que desarrollen inventarios de la
													biodiversidad, desarrollo de planes territoriales, auditoría ambiental,
													diseño y gestión de áreas protegidas, entre otros.
												</li>
												<li>
													Trabajar en numerosos campos de ciencia básica y aplicada, como
													planificación del aprovechamiento de recursos (pesquerías, acuicultura,
													forestaría, fauna silvestre, silvicultura, etc.), museística conservación
													y gestión de especies vegetales o animales, plagas agrícolas o forestales,
													entomología aplicada, divulgación científica, y otros.
												</li>
											</ul>
											<div className="mb-3">
												<p className="title-dark mb-1">Comité coordinador de la Maestría:</p>
												<ul className="nav flex-column ml-3">
													<li>Dr. Manuel Marín Bravo (Presidente)</li>
													<li>Mg. Mery Suni Ninataype</li>
													<li>Mg. José Roque Gamarra</li>
												</ul>
											</div>
