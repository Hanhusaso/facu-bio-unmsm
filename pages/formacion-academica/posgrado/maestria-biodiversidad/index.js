...
const index = () => {
    ...
    useEffect(() => {
        (async () => {
          const response = await getDocenteByIdInformacionAcademicaApi("maestria_en_investigacion_en_biodiversidad_y_gestion_de_ecosistemas");
                                ...
                                <Col md="3" lg="2">
                                    <div className="mb-4">
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a href="/assets/archivos/posgrado/planes de estudio/plan-estudio-2020-maestria-biodiversidad-gestion-ecosistemas.pdf" target="_blank" className="tab d-flex">
                                                    <div>
                                ...
                                <Col md="7" lg="8">
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            ...
                                            <p>
                                                La Universidad Nacional Mayor de San Marcos forma Magísteres en Biodiversidad y Gestión de Ecosistemas altamente capacitados para conducir actividades o programas sobre biodiversidad y de gestión de ecosistemas a nivel de la planificación y ejecución operativa, científica y tecnológica. El graduado logrará incrementar su capacidad innovadora y crítica desarrollando estrategias de gestión de enfoque ecosistémico y de participación integral.
                                            </p>
                                            ...
                                            <p>
                                                Profesionales que estén en posesión del grado académico de Bachiller en Ciencias Biológicas, Ciencias Ambientales, Ingeniero Agrónomo, Veterinaria o disciplinas afines, otorgados por universidades nacionales o extranjeras que quieran asegurar una formación de posgrado en recursos humanos especializados en el estudio, gestión y conservación de los recursos biológicos del país.
                                            </p>
                                            ...
                                            <ul className="chevron-green-dark">
                                                <li>
                                                    Conocer aspectos tantos teóricos como prácticos de la Diversidad animal y de la Diversidad vegetal; y los conocimientos y experiencia necesarios para que se incorpore al ámbito laboral.
                                                </li>
                                                <li>
                                                    Identificar taxones de animales y vegetales, conocer los fundamentos biológicos de la taxonomía y su aplicabilidad a la gestión sostenible de ecosistemas terrestres y marinos, la ciencia forestal, la arqueología, etc.
                                                </li>
                                                <li>
                                                    Tener las habilidades que les permitirán ejercer sus actividades en empresas, organizaciones e instituciones que desarrollen inventarios de la biodiversidad, desarrollo de planes territoriales, auditoría ambiental, diseño y gestión de áreas protegidas, entre otros.
                                                </li>
                                                <li>
                                                    Trabajar en numerosos campos de ciencia básica y aplicada, como planificación del aprovechamiento de recursos (pesquerías, acuicultura, forestaría, fauna silvestre, silvicultura, etc.), museística conservación y gestión de especies vegetales o animales, plagas agrícolas o forestales, entomología aplicada, divulgación científica, y otros.
                                                </li>
                                            </ul>
                                            <div className="mb-3">
