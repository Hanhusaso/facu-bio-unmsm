        ...
        <>
            <Layout title="Maestría en Genética">
                <div>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Breadcrumb>
                                        ...
                                        <Breadcrumb.Item active>Maestría en Genética</Breadcrumb.Item>
                                    </Breadcrumb>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                    ...
                    <div>
                        <Container className="mb-3">
                            <Row>
                                <Col md="1"></Col>
                                <Col>
                                    <div className="title-page text-center">Maestría en Genética</div>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                        </Container>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/posgrado/maestria genetica/banner-maestria-genetica-unmsm.png" alt="" />
                    </div>
                                ...
                                <Col md="3" lg="2">
                                    <div className="mb-4">
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a href="/assets/archivos/posgrado/planes de estudio/plan-estudio-2020-maestria-genetica.pdf" target="_blank" className="tab d-flex">
                                                    <div>
                                    ...
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            ...
                                            <ul className="chevron-green-dark">
                                                <li>
                                                    Formar investigadores científicos y docentes calificados para conocer los genes, cómo se organizan, transmiten, cómo y cuándo se expresan, como cambiar y cuál es su destino en el espacio y en el tiempo.
                                                </li>
                                                <li>
                                                    El mejoramiento genético de especies útiles de la biodiversidad y la formación del banco de genes.
                                                </li>
                                                <li>
                                                    El establecimiento de marcadores genéticos aplicados a la mejora genética.
                                                </li>
                                            </ul>
                                            ...
                                            <p>
                                                Dirigido a profesionales con grado académico de bachiller en Ciencias Biológicas, Medicina, Farmacia, Agrónomos y otras áreas afines que deseen profundizar sus conocimientos para entender y proponer soluciones a las reacciones de los organismos frente los problemas climáticos, de salud y alimentación que afectan a la humanidad.
                                            </p>
                                            ...
                                            <ul className="chevron-green-dark">
                                                <li>
                                                    Investigar sobre los mecanismos de transmisión de la herencia en poblaciones humanas, animales, vegetales y microbianas.
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    Diseñar, ejecutar y evaluar proyectos de investigación en el análisis genético por medio de herramientas moleculares, estadísticas y bioinformática contribuyendo al conocimiento genético de la biodiversidad del país.
                                                </li>
                                            </ul>
                                            <div className="mb-3">
                                                ...
                                                <ul className="nav flex-column ml-3">
                                                    <li>Mg. María Gisella Orjeda Fernández (Presidenta)</li>
                                                    <li>Dra. Jorge Luis Rmirez Malaver</li>
                                                    <li>Mg. Gustavo Adolfo Sandoval Peña</li>
                                                </ul>
                                            </div>
