									...
									<div className="mb-3 tab-content" id="v-pills-tabContent">
										...
										>
											...
											<p>
												...
												espontánea e inducida en función del tiempo y las condiciones ambientales.
												Así mismo, utilizar las herramientas moleculares para su aislamiento,
												conservación y empleo en el mejoramiento genético a través de librerías y
												bancos génicos.
											</p>
											...
											<ul className="chevron-green-dark">
												<li>
													Formar investigadores científicos y docentes calificados para conocer los
													genes, cómo se organizan, transmiten, cómo y cuándo se expresan, como
													cambiar y cuál es su destino en el espacio y en el tiempo.
												</li>
												<li>
													El mejoramiento genético de especies útiles de la biodiversidad y la
													formación del banco de genes.
												</li>
												<li>
											...
											<p>
												Dirigido a profesionales con grado académico de bachiller en Ciencias
												Biológicas, Medicina, Farmacia, Agrónomos y otras áreas afines que deseen
												profundizar sus conocimientos para entender y proponer soluciones a las
												reacciones de los organismos frente los problemas climáticos, de salud y
												alimentación que afectan a la humanidad.
											</p>
											...
											<ul className="chevron-green-dark">
												<li>
													Investigar sobre los mecanismos de transmisión de la herencia en
													poblaciones humanas, animales, vegetales y microbianas.
												</li>
												<li>
												...
												<li>
													Diseñar, ejecutar y evaluar proyectos de investigación en el análisis
													genético por medio de herramientas moleculares, estadísticas y
													bioinformática contribuyendo al conocimiento genético de la biodiversidad
													del país.
												</li>
											</ul>
											<div className="mb-3">
