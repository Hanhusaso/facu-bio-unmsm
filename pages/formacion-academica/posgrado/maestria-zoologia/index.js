...
const index = () => {
    ...
    useEffect(() => {
        (async () => {
          const response = await getDocenteByIdInformacionAcademicaApi("maestria_en_zoologia");
        ...
        <>
            <Layout title="Maestría en Zoología">
                <div>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Breadcrumb>
                                        ...
                                        <Breadcrumb.Item active>Maestría en Zoología</Breadcrumb.Item>
                                    </Breadcrumb>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                    ...
                    <div>
                        <Container className="mb-3">
                            <Row>
                                <Col md="1"></Col>
                                <Col>
                                    <div className="title-page text-center">Maestría en Zoología</div>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                        </Container>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/posgrado/maestria zoologia/banner-maestria-zoologia-unmsm.png" alt="" />
                    </div>
                                ...
                                <Col md="3" lg="2">
                                    <div className="mb-4">
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a href="/assets/archivos/posgrado/planes de estudio/plan-estudio-2020-maestria-zoologia.pdf" target="_blank" className="tab d-flex">
                                                    <div>
                                ...
                                <Col md="7" lg="8">
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            <p>
                                                La Maestría de Zoología de la Facultad de Ciencias Biológicas de la Universidad Nacional Mayor de San Marcos ofrece el grado académico respectivo mediante el desarrollo de cuatro semestres con cursos básicos y electivos; conducidos por profesores–investigadores especialistas en fauna peruana
                                            </p>
                                            <div className="mb-3">
