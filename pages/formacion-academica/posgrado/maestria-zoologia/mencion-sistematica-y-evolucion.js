...
const mencionSistematicaYEvolucion = () => {
	const asignaturas_obligatorias = planEstudios.filter(
		(plan) =>
			plan.program_name ===
				'maestria-en-zoologia-con-mencion-en-sistematica-y-evolucion' &&
									...
									>
										...
										>
											<PlanDeEstudio
												...
												plan_estudio="https://biologia-unmsm.s3.us-east-2.amazonaws.com/plan-estudio/Plan+de+estudio+M+Zoolog%C3%ADa+menci%C3%B3n+Sistem%C3%A1tica+y+Evoluci%C3%B3n.pdf"
											/>
										</div>
									</div>
									{width < 768 && (
