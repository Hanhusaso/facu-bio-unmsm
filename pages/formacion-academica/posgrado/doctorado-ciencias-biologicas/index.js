							...
							<Row>
								...
								<Col md="7" lg="8">
									<div className="mb-3 tab-content" id="v-pills-tabContent">
										...
										>
											<p>
												El programa de Doctorado en Ciencias Biológicas es escolarizado desde el año
												2000, tuvo una duración de cuatro semestres. El año 2011 se planteó el
												currículo del Doctorado en Ciencias Biológicas con una duración de seis
												semestres académicos, tal como posteriormente lo indicó la nueva Ley
												Universitaria Nº30220 en el 2014.
											</p>
											<p>
												El presente currículo ha sido elaborado para adecuarse a las normas
												presentes en el Reglamento General de Estudios de Posgrado aprobado con
												Resolución Rectoral 04790-R-18.
											</p>
											<div className="mb-3">
												<p className="title-dark mb-1">1. Fecha de creación del Programa</p>
											...
											<div className="mb-3">
												<p className="title-dark mb-1">2. Fecha de modificación del programa:</p>
												<ul className="nav flex-column ml-3">
											...
											<p className="title-dark">Sumilla del Programa</p>
											<p>
												...
												diversas áreas del conocimiento biológico, con especial énfasis en los
												campos de la biodiversidad y biología molecular.
											</p>

											<p className="title-dark">Grado que se otorga:</p>
											<p>Doctor en Ciencias Biológicas</p>

											<p className="title-dark">Objetivos académicos:</p>
											<p>
												El Programa de Doctorado en Ciencias Biológicas tiene como finalidad la
												formación de investigadores sobre la evolución y uso sostenible de la
												diversidad biológica, así como la capacitación para su futura incorporación
												en universidades, instituciones de investigación y centros de gestión tanto
												privados como de la administración pública. Asimismo, comprenderán y
												aplicarán los conceptos actuales de la biología molecular en arqueas,
												bacterias y eucariontes, contribuyendo con el conocimiento tanto en el área
												básica como aplicada a fin de lograr el aprovechamiento racional de nuestra
												megabiodiversidad. El Programa ofrece a los estudiantes la oportunidad de
												trabajar con reconocidos investigadores en diferentes tópicos relacionados
												con las prioridades actuales del país.
											</p>

											<p className="title-dark">Dirigido a:</p>
											<p>
												Profesionales que hayan concluido los estudios de Maestría o estén en
												posesión del Grado de Magíster en áreas de las Ciencias Biológicas o en
												disciplinas afines, otorgados por universidades nacionales o extranjeras que
												aseguren una formación acorde a los fines del Programa.
											</p>

											<p className="title-dark">Duración:</p>
											<p>3 años (6 semestres)</p>

											<p className="title-dark">Perfil del graduado:</p>
											<ul className="chevron-green-dark">
												<li>
													Generar nuevos conocimientos científicos y técnicos en las Ciencias
													Biológicas a través de la realización de trabajos originales. Estará
													capacitado para manejar y aplicar las metodologías que permitan resolver
													problemas de investigación en las diversas áreas del conocimiento
													biológico con especial énfasis en los campos de la biodiversidad y
													biología molecular.
												</li>
												<li>
													Desarrollar nuevas tecnologías para resolver problemas, detectar
													necesidades y oportunidades inherentes a su área de investigación. En
													particular, conocer y utilizar aproximaciones estadísticas contemporáneas.
												</li>
												<li>
													Formular, gestionar y liderar proyectos de investigación, trabajando en
													equipo y en redes interdisciplinarias. Como consecuencia, será capaz de
													plantear y ejecutar hipótesis de trabajo, describir e interpretar
													resultados experimentales y analizar de forma crítica los descubrimientos
													presentados en las publicaciones científicas.
												</li>
												{/* <li>
