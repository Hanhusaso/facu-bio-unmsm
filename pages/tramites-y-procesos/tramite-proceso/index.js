...
const tramiteProceso = () => {
	...
	useEffect(() => {
		...
		(async () => {
			...
			const response = await getTramiteProcesoByUrlApi(
				currentUrlTramiteProceso
			);
			if (size(response) == 0) {
						...
						<div>
							<Container className="mb-3">
								<Row>
									<Col md="1"></Col>
									<Col>
										<div className="title-page text-center mb-3">
											{tramiteProceso.nombre_tramite}
										</div>
									</Col>
									<Col md="1"></Col>
								...
								<Row>
									...
									<Col md="7" lg="8">
										<p>
											...
											<span>
												{tramiteProceso.dirigido_a
													.split(' || ')
													.map((dirigido_a, index) =>
														index !=
														tramiteProceso.dirigido_a.split(
															' || '
														).length -
															1
															? dirigido_a + ' y '
										...
										<p>
											...
											<span
												dangerouslySetInnerHTML={{
													__html: tramiteProceso.descripcion,
												}}
											/>
										</p>
										<p>
											<span className="mr-2 font-weight-bold">
												Este trámite tiene fecha límite:
											</span>
											<span
												dangerouslySetInnerHTML={{
													__html: tramiteProceso.fecha_limite,
												}}
											/>
										</p>
										...
										<p>
											{tramiteProceso.agregarPasosPorDefecto ===
												null ||
											tramiteProceso.agregarPasosPorDefecto ===
												true ? (
												<ul className="nav flex-column">
													...
													<ul
														className="chevron-green-dark mb-3"
														dangerouslySetInnerHTML={{
															__html: tramiteProceso.descripcion_requisito,
														}}
													/>
