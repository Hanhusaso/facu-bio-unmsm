...
const index = () => {
		...
		return (
			<div className="contacto-wrapper mb-3">
				...
				<div className="grid-contacto">
					...
					<div>
						<span>+(51) 619 7000 anexo 7543</span>
					</div>
				</div>
				<div className="mb-2 grid-contacto">
					...
					<div>
						<span>movilidad.ogcri@unmsm.edu.pe</span>
					</div>
				</div>
	...
	return (
		<>
			<Layout title="Movilidad estudiantil">
				<div>
					<div>
						<Container>
							<Row>
								...
								<Col>
									<Breadcrumb>
										...
										<Breadcrumb.Item active>
											Comunidad: Movilidad estudiantil
										</Breadcrumb.Item>
									</Breadcrumb>
								</Col>
								<Col md="1"></Col>
					...
					<div className="mb-4">
						<img
							className="w-100"
							src="https://biologia-unmsm.s3.us-east-2.amazonaws.com/movilidad_auto_x2_4379c5973e.jpeg"
							alt=""
						/>
					</div>
									...
									<div
										...
										<div
											...
											<p>
												...
												Cooperaci&oacute;n y Relaciones
												Interinstitucionales, promueve
												programas de movilidad
												acad&eacute;mica a trav&eacute;s
												de una variedad de convenios
												interinstitucionales nacionales
												e internacionales, puedes
												revisar la lista completa en el
												siguiente enlace:{' '}
												<a
													target="_blank"
													href="https://cooperacion.unmsm.edu.pe/relacion.html">
													https://cooperacion.unmsm.edu.pe/relacion.html
												</a>
											</p>
											<p>
												<strong>
											...
											<p>
												Dirigido a estudiantes externos
												(nacionales y extranjeros) de
												pregrado o posgrado, que deseen
												realizar una estancia en la
												UNMSM, durante un per&iacute;odo
												m&aacute;ximo de dos semestres
												acad&eacute;micos y obtener una
												certificaci&oacute;n oficial de
												las actividades realizadas para
											...
											<ul>
												<li aria-level="1">
													...
													instituciones con las que la
													UNMSM tiene firmado convenio
													de cooperaci&oacute;n, (ver
													link de convenios) Durante
													su estancia, los Estudiantes
													de Intercambio est&aacute;n
													exonerados del pago de los
													costos acad&eacute;micos y
													tienen los mismos derechos
													que un estudiante regular
													para hacer uso de los
													servicios que brinda la
													Universidad.
												</li>
												<li aria-level="1">
													Estudiantes libres: Dirigido
													a estudiantes de
													instituciones con las que la
													UNMSM no tiene firmado
													convenio de
													cooperaci&oacute;n. Durante
													su estancia, los Estudiantes
													Libres pagar&aacute;n los
													costos del Programa y los
											...
											<p>
												...
												<a
													target="_blank"
													href="https://cooperacion-unmsm.blogspot.com/p/el-programa-de-movilidad-academica-para.html">
													https://cooperacion-unmsm.blogspot.com/p/el-programa-de-movilidad-academica-para.html
												</a>
											</p>
											<p>
												<strong>
											...
											<p>
												...
												sanmarquinos de pre y posgrado
												el cual permite fortalecer y
												enriquecer sus competencias
												acad&eacute;micas, profesionales
												y personales a trav&eacute;s de
												una experiencia acad&eacute;mica
												internacional.
											</p>
											<p>
												Mediante el Programa de
												Movilidad Universitaria (PMU),
												los estudiantes sanmarquinos
												cuentan con la oportunidad de
												realizar un intercambio
												acad&eacute;mico por un periodo
												de un semestre o dos como
												m&aacute;ximo en las mejores
												universidades de Am&eacute;rica,
												Asia y Europa. Son m&aacute;s de
												60 instituciones con las que se
												mantiene convenio de intercambio
												bilateral.
											</p>
											<p>Requisitos:</p>
											<p>
												Verificar que eres estudiante
												potencial, cumpliendo con los
												siguientes requisitos:
											</p>
											<ul>
												<li aria-level="1">
													Estudiantes regulares con
													matr&iacute;cula vigente y
													que est&eacute;n llevando al
													menos 12 cr&eacute;ditos.
												</li>
												<li aria-level="1">
													Haber completado el 50% de
													su plan de estudios y no
													estar en el d&eacute;cimo
													ciclo.
												</li>
												<li aria-level="1">
													Ser del tercio o quinto
													superior.
												</li>
												<li aria-level="1">
													Contar con el dominio del
													idioma en que se imparte en
											...
											<p>
												...
												<a
													target="_blank"
													href="https://cooperacion-unmsm.blogspot.com/p/movilidad-para-sanmarquinos.html">
													https://cooperacion-unmsm.blogspot.com/p/movilidad-para-sanmarquinos.html
												</a>
											</p>
										</div>
									</div>
