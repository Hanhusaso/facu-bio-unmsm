                                    ...
                                    <Breadcrumb>
                                        ...
                                        <li className="breadcrumb-item">
                                            <Link href="/comunidad/testimonios">
                                                <a role="button">Comunidad: Testimonios</a>
                                            </Link>
                                        </li>
                                        <Breadcrumb.Item active>Testimonio</Breadcrumb.Item>
                                    </Breadcrumb>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                    ...
                    <div>
                        <Container className="mb-3">
                            <Row>
                                <Col md="1"></Col>
                                <Col>
                                    <div className="title-page text-center mb-1">Bach. María Cárdenas López  </div>
                                    <div className="sub-title text-center">E.P. Microbiología y Parasitología </div>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                        </Container>
