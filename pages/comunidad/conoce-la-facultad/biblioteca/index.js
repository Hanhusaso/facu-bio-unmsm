        ...
        <>
            <Layout title="Biblioteca">
                <div>
                    ...
                    <div>
                        <Container className="mb-3">
                            <Row>
                                <Col md="1"></Col>
                                <Col>
                                    <div className="title-page text-center">Biblioteca</div>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                        </Container>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/comunidad/biblioteca/biblioteca_banner.jpg" alt="" />
                    </div>
                                ...
                                <Col md="3" lg="2">
                                    <div className="mb-4">
                                        ...
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a className="tab d-flex" id="v-pills-objetivos-tab" data-toggle="pill" href="#v-pills-objetivos" role="tab" aria-controls="v-pills-objetivos" aria-selected="false">
                                                    <div>
                                                ...
                                                <a className="tab d-flex" id="v-pills-servicios-tab" data-toggle="pill" href="#v-pills-servicios" role="tab" aria-controls="v-pills-servicios" aria-selected="false">
                                                    <div>
                                                        <svg width="25" height="25" viewBox="0 0 25 25" className="icon mr-3" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <Col md="4" lg="6">
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            <div>
                                                <p>
                                                    La Unidad de Biblioteca, Hemeroteca y Centro de Documentación de la Facultad de Ciencias Biológicas ofrece sus servicios a través de una biblioteca especializada. Cuenta con acervo bibliográfico para el uso de los estudiantes de las tres Escuelas Profesionales de la facultad y de carreras afines.
                                                </p>
                                                <p>
                                                    La Biblioteca inició sus funciones en el año 1989, en la gestión decanal del Dr. Raúl Verano Montesinos, y a partir de la fecha se viene implementando con herramientas necesarias para satisfacer las necesidades informativas de los alumnos de pre y posgrado, docentes, personal administrativo, la comunidad universitaria en general y usuarios externos.
                                                </p>
                                                <p>
                                                    Es importante recalcar que la biblioteca se encuentra bajo la dirección, coordinación y normatividad del Sistema de Bibliotecas y Biblioteca Central de la UNMSM y comparte la misión de ser un centro de recursos de información y difusión del conocimiento científico, tecnológico y humanístico que contribuya en la formación académico profesional y la investigación, brindando servicios de información pertinentes y de calidad, asumiendo el compromiso institucional de la Universidad.
                                                </p>
                                                <p className="title-dark">Jefe de la Unidad de Biblioteca, Hemeroteca</p>
                                                <p>Luis Alberto Ulloa Suarez</p>
                                                <a className="btn-green-bright" href="https://unmsm.ent.sirsi.net/client/es_ES/all_libs/?dt=list" target="_blank">Ver catálogo en línea</a>
                                            </div>
                                        </div>
                                        <div className="mb-3 tab-pane fade" id="v-pills-objetivos" role="tabpanel" aria-labelledby="v-pills-objetivos-tab">
                                            <div>
                                                <p>
                                                    Tenemos como objetivos ofrecer una organización moderna y servicios de calidad en nuestra sede; fomentar el uso de las herramientas que dan acceso a los recursos del Sistema de Bibliotecas y Biblioteca Central de la Universidad de manera virtual; mejorar e incrementar las herramientas de comunicación de la Biblioteca con la comunidad universitaria y sociedad en general; adecuar la colección, los espacios y el equipamiento de la Biblioteca Universitaria al entorno educativo y la nueva realidad.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="mb-3 tab-pane fade" id="v-pills-servicios" role="tabpanel" aria-labelledby="v-pills-servicios-tab">
                                            <div>
                                                <p className="title-dark">Servicios que se brindan:</p>
                                                <ul className="chevron-green-dark">
                                                    <li>
                                                        <b>Préstamo en Sala: </b>
                                                        <span>Libros de Lectura Interna y Tesis. Solo para realizar su lectura y anotaciones en sala.</span>
                                                    </li>
                                                    <li>
                                                        <b>Préstamo a Domicilio: </b>
                                                        <span>Esta prestación es por dos días según la disponibilidad del texto. Existe mora por libro no entregado a la fecha.</span>
                                                    </li>
                                                    <li>
                                                        <b>Préstamo Interbibliotecario Interno y Externo.</b>
                                                    </li>
                                                    <li>
                                                        <b>Información bibliográfica y general: </b>
                                                        <span>Se brinda guía a los usuarios a una mayor información para su desarrollo académico y trámite documentario.</span>
                                                        <br/>
                                                        <span>Se cuenta con computadoras como herramientas para obtener alguna información adicional o consulta informática, descargar algún archivo o viceversa y para temas diversos de orden de investigación científica. Son de uso exclusivo de los alumnos de la facultad.</span>
                                                    </li>
                                                    <li>
                                                        <b>Horario de Atención: </b>
                                                        <span>Para alumnos de la facultad con carné de biblioteca vigente (de lunes a sábado de 08:15 am a 08:00 pm).</span>
                                                    </li>
                                                    <li>
                                                        <b>Visitantes: </b>
                                                        <span>Para alumnos de otras facultades de la UNMSM. Con carné de biblioteca y carné universitario (jueves y sábados, de 08:15 am a 08:00 pm), Alumnos externos con DNI y carnet universitario (Todos los días, de 08:15 am a 08:00 pm).</span>
                                                        <br/>
                                                        <span>Público en general con DNI (Todos los días, de 08:15 am a 08:00 pm.)</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
