								...
								<Col>
									<Breadcrumb>
										...
										<Breadcrumb.Item active>
											Comunidad: Centro de Responsabilidad
							...
							<Row>
								...
								<Col>
									<div className="title-page text-center">
										...
										Extensión Universitaria - CERSEU
									</div>
								</Col>
								<Col md="1"></Col>
							</Row>
									...
									<div
										...
										<div
											...
											<p>
												...
												Biológicas (CERSEU-FCB-UNMSM),
												es un órgano de línea, cuyo
												objetivo principal es integrar
												nuestra Facultad a la sociedad,
												organiza la extensión social y
												la prestación de servicios con
												el apoyo de docentes,
												estudiantes y administrativos,
												contribuyendo con la vinculación
												de la academia con la comunidad
												y los sectores productivos del
												país.
											</p>
											<p>
												Esta importante labor se
												desarrolla a través de la
												realización de actividades que
												permitan transferir a la
												comunidad nuestro conocimiento
												científico, tecnológico,
												humanístico y de cooperación;
												brindando conferencias, mesa
												redondas, cursos de
												capacitación, de actualización,
												asistencia técnica y asesorías,
												entre otros. Así mismo,
												desarrolla y promueve talleres
												artísticos culturales y
												deportivos.
											</p>
											<p>
												El CERSEU ha venido
												desarrollando actividades las
												cuales permiten a la Facultad
												captar recursos propios para
												invertirlos en su desarrollo,
												contribuyendo activamente en el
												proceso de enseñanza-aprendizaje
												y la investigación aplicada. Así
												mismo, que permitan solucionar
												problemas de índole social
												mediante eficaces medios de
												información, comunicación y
												gestión relacionadas a áreas de
												salud, ecología, educación
												ambiental, genética,
												microbiología, reproducción,
												parasitología, botánica entre
												otros. Brindando además visitas
												guiadas a las diferentes
												instalaciones de la Facultad.
												Llevándose en la actualidad
												estas actividades de forma no
												presencial.
											</p>
											<p className="title-dark">Misión</p>
											<p>
												Contribuir al desarrollo de la
												sociedad impartiendo una sólida
												actualización y capacitación a
												través de los programas o
												servicios de los grupos de
												investigación.
											</p>
										</div>
										<div
											...
											<ul className="chevron-green-dark">
												<li>
													...
													nuestros conocimientos a fin
													de extender nexos que nos
													permita transferir nuestro
													conocimiento, ciencia y
													tecnología así como los
													servicios que ofrece la
													Facultad a través de los
													grupos de investigación.
												</li>
												<li>
													Promover la suscripción de
													convenios y prestación de
													servicios con instituciones
													públicas o privadas en áreas
										...
										<div
											...
											<p>
												Formado por el director y su
												comité directo constituido por
												cuatro miembros docentes de la
												Facultad
											</p>
											<p>
												...
												Extensión Universitaria (CERSEU)
												ejerce liderazgo sobre el
												personal que conforma su
												organización.
											</p>
											<p>
												Es responsable ante el Decanato
												y Consejo de Facultad del
												cumplimiento de sus funciones.
												Coordina internamente con las
												Escuelas Profesionales,
												Departamentos Académicos de la
												Facultad, Comisión Permanente de
												Relaciones Interfacultativas y
												Convenios Nacionales e
												Internacionales.
											</p>
											<p>
												Externamente coordina con los
												CERSEU de las demás Facultades y
												la Dirección General de
												Responsabilidad Social
												Universitaria (DGRSU) de la
