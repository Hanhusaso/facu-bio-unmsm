        ...
        <>
            <Layout title="CERSEU">
                <div>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/comunidad/cerseu/cerseu-banner-biologia.png" alt="" />
                    </div>
                                ...
                                <Col md="3" lg="2">
                                    <div className="mb-4">
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                ...
                                                <a className="tab d-flex" id="v-pills-estructura-tab" data-toggle="pill" href="#v-pills-estructura" role="tab" aria-controls="v-pills-estructura" aria-selected="false">
                                                    <div>
                                                        <svg width="23" height="23" viewBox="0 0 23 23" className="icon mr-3" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8.06543 0.818359H0.0654297V8.81836H8.06543V5.81836H10.0654V19.8184H14.0654V22.8184H22.0654V14.8184H14.0654V17.8184H12.0654V5.81836H14.0654V8.81836H22.0654V0.818359H14.0654V3.81836H8.06543V0.818359ZM20.0654 2.81836H16.0654V6.81836H20.0654V2.81836ZM16.0654 16.8184H20.0654V20.8184H16.0654V16.8184Z"/>
                                                        </svg>
                                                    </div>
                                ...
                                <Col md="4" lg="6">
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-presentacion" role="tabpanel" aria-labelledby="v-pills-presentacion-tab">
                                            <p>
                                                El Centro de Responsabilidad Social y Extensión Universitaria  de la Facultad de Ciencias Biológicas (CERSEU-FCB-UNMSM), es un órgano de línea, cuyo objetivo principal es integrar nuestra Facultad a la sociedad, organiza la extensión social y la prestación de servicios con el apoyo de docentes, estudiantes y administrativos, contribuyendo con la vinculación de la academia con la comunidad y los sectores productivos del país.
                                            </p>
                                            <p>
                                                Esta importante labor se desarrolla a través de la realización de actividades que permitan transferir a la comunidad nuestro conocimiento científico, tecnológico, humanístico y de cooperación; brindando conferencias, mesa redondas, cursos de capacitación, de actualización, asistencia técnica y asesorías, entre otros. Así mismo, desarrolla y promueve talleres artísticos culturales y deportivos.
                                            </p>
                                            <p>
                                                El CERSEU ha venido desarrollando actividades las cuales permiten a la Facultad captar recursos propios para invertirlos en su desarrollo, contribuyendo activamente en el proceso de enseñanza-aprendizaje y la investigación aplicada. Así mismo, que permitan solucionar problemas de índole social mediante eficaces medios de información, comunicación y gestión relacionadas a áreas de salud, ecología, educación ambiental, genética, microbiología, reproducción, parasitología, botánica entre otros. Brindando además visitas guiadas a las diferentes instalaciones de la Facultad. Llevándose en la actualidad estas actividades de forma no presencial.
                                            </p>
                                            <p className="title-dark">Misión</p>
                                            <p>
                                                Contribuir al desarrollo de la sociedad impartiendo una sólida actualización y capacitación a través de los programas o servicios de los grupos de investigación.
                                            </p>
                                        </div>
                                        <div className="mb-3 tab-pane fade" id="v-pills-objetivos" role="tabpanel" aria-labelledby="v-pills-objetivos-tab">
                                            <ul className="chevron-green-dark">
                                                <li>
                                                    Proyectar a la comunidad nuestros conocimientos a fin de extender nexos que nos permita transferir nuestro conocimiento, ciencia y tecnología así como los servicios que ofrece la Facultad a través de los grupos de investigación.
                                                </li>
                                                <li>
                                                    Promover la suscripción de convenios y prestación de servicios con instituciones públicas o privadas en áreas de nuestra competencia.
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="mb-3 tab-pane fade" id="v-pills-estructura" role="tabpanel" aria-labelledby="v-pills-estructura-tab">
                                            <p className="title-dark">Organización</p>
                                            <p>
                                                Formado por el director y su comité directo constituido por cuatro miembros docentes de la Facultad
                                            </p>
                                            <p>
                                                La Dirección del Centro de Responsabilidad Social y Extensión Universitaria (CERSEU) ejerce liderazgo sobre el personal que conforma su organización.
                                            </p>
                                            <p>
                                                Es responsable ante el Decanato y Consejo de Facultad del cumplimiento de sus funciones. Coordina internamente con las Escuelas Profesionales, Departamentos Académicos de la Facultad, Comisión Permanente de Relaciones Interfacultativas y Convenios Nacionales e Internacionales.
                                            </p>
                                            <p>
                                                Externamente coordina con los CERSEU de las demás Facultades y la Dirección General de Responsabilidad Social Universitaria (DGRSU) de la Universidad Nacional Mayor de San Marcos.
                                            </p>
                                        </div>
                                    </div>
                                    {width < 768 && (
