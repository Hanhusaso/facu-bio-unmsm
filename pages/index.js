							...
							<Container fluid>
								<Row>
									<Col md={{ span: 4, offset: 1 }}>
										<p className="mb-0">Entérate de las últimas novedades</p>
										...
										<div className="card-bio">
											...
											<div className="part-text">
												...
												<p className="desc-card mb-0">
													...
													“han reescrito un artículo muy interesante sobre la estructura del...
												</p>
											</div>
										</div>
									</Col>
								...
								<Col md={{ span: 4 }}>
									...
									>
										<Carousel.Item>
											...
											<p>
												Formamos profesionales e investigadores líderes en la generación y difusión
												del conocimiento científico de nuestra diversidad biológica, con valores
												respetuosos de la diversidad cultural, promotores de la identidad nacional
												basada en una cultura de calidad y responsabilidad social para contribuir al
												desarrollo sostenible del país y la sociedad.
											</p>
										</Carousel.Item>
										<Carousel.Item>
