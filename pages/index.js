											...
											<div className="d-flex align-items-end mb-5 position-relative">
												...
												<div className="txt-numeros-bg">
													...
													<div className="text-right">
														<span className="big-badge recolor">
															números
														</span>
													</div>
												</div>
												...
												<Container>
													<Row>
														...
														<Col>
															<div className="wrapper-icon">
																<img
																	src="/assets/img/iconos/icono_lupa_numeros.png"
																	alt="lupa"
																/>
															</div>
															<div>
														...
														<Col>
															<div className="wrapper-icon">
																<img
																	src="/assets/img/iconos/icono_tesis_numeros.png"
																	alt="tesis"
																/>
															</div>
															<div>
