...
import {getInformacionAcademicaByUrlApi, getHorarioByIdInformacionAcademicaApi} from '../api/informacion-academica';
    ...
    useEffect(() => {
        ...
        (async () => {
          ...
          if(size(response) == 0){
            ...
            const response1 = await getHorarioByIdInformacionAcademicaApi(response[0].id);
            setHorario(response1[0]);
                                        ...
                                        <Col md="7" lg="8">
                                            <div>
                                                <div className="mb-4">
                                                    ...
                                                    <object data={horario.url_documento} type="application/pdf" width="100%" height="700px"> 
                                                        <a href={horario.url_documento}>
