...
import {
	countProyectosApi,
	getProyectosApi,
	countProyectosByGrupoInvestigacionApi,
} from '../../api/proyectos';
...
export default function Proyectos() {
	...
	useEffect(() => {
		...
		(async () => {
			const count_grupo_1 = await countProyectosByGrupoInvestigacionApi(
				'biologia_molecular_y_biotecnologia'
			);
			setCountGrupo1(count_grupo_1);
			const count_grupo_2 = await countProyectosByGrupoInvestigacionApi(
				'biotecnologia_para_la_remediacion'
			);
			setCountGrupo2(count_grupo_2);
			const count_grupo_3 = await countProyectosByGrupoInvestigacionApi(
				'reproduccion_biologia_del_desarrollo_y_ecotoxicologia'
			);
			setCountGrupo3(count_grupo_3);
			const count_grupo_4 = await countProyectosByGrupoInvestigacionApi(
				'citogenetica_y_sistemas_modelo_de_drosophila'
			);
			setCountGrupo4(count_grupo_4);
			const count_grupo_5 = await countProyectosByGrupoInvestigacionApi(
				'con-responsable'
			);
	...
	useEffect(() => {
		(async () => {
			if (palabra == '') {
				const response1 = await countProyectosApi(
					palabra,
					gruposInvestigacion,
					tipos,
					fechas
				...
				setPaginador(
					<Pagination
						...
						totalPages={Math.ceil(response1 / 4.0)}
		...
		<>
					...
					<div>
						...
						<Container className="mb-3">
							<Row>
								<Col md="1"></Col>
								<Col>
									Estamos orgullos del trabajo que hacen
									nuestros estudiantes, docentes y egresados
									de la facultad para generar conocimiento e
									impacto en la sociedad. Ponemos a
									disposición el resultado de su esfuerzo,
									esperando visibilizar soluciones a los
									problemas actuales y motivar a futuros
									investigadores. Puedes publicar tu proyecto
									o saber más sobre los grupos de
									investigación.
								</Col>
								<Col md="1"></Col>
							</Row>
						...
						<div className="w-100 position-relative mb-5 admision-posgrado">
							...
							<div className=" h-100 d-flex justify-content-center align-items-center position-relative">
								<div className="text-white mr-md-5 mr-0 mt-3 mb-3 mt-md-0 mb-md-0 justify-content-center align-items-centers text-center d-flex flex-column">
									{/* <h3 className="font-weight-bold principal-title">
										Conoce los proyectos <br /> de la
										Facultad
									</h3> */}
									{/* <h2></h2> */}
									<h5>
										<strong>
											Conoce los proyectos de la Facultad{' '}
											<br /> ganadores
										</strong>{' '}
										...
										<div className="mb-3">
											...
											<div>
												<div className="input-group mb-1">
													<input
														type="checkbox"
														id="biologia_molecular_y_biotecnologia_1"
														name="biologia_molecular_y_biotecnologia"
														value="biologia_molecular_y_biotecnologia"
														onChange={
															onChangeGrupoInvestigacion
														}
													/>
													<label
														className="mb-0"
												...
												<div className="input-group mb-1">
													<input
														type="checkbox"
														id="biotecnologia_para_la_remediacion_1"
														name="biotecnologia_para_la_remediacion"
														value="biotecnologia_para_la_remediacion"
														onChange={
															onChangeGrupoInvestigacion
														}
													/>
												...
												<div className="input-group mb-1">
													<input
														type="checkbox"
														id="reproduccion_biologia_del_desarrollo_y_ecotoxicologia_1"
														name="reproduccion_biologia_del_desarrollo_y_ecotoxicologia"
														value="reproduccion_biologia_del_desarrollo_y_ecotoxicologia"
														onChange={
															onChangeGrupoInvestigacion
														}
													/>
												...
												<div className="input-group mb-1">
													<input
														type="checkbox"
														id="citogenetica_y_sistemas_modelo_de_drosophila_1"
														name="citogenetica_y_sistemas_modelo_de_drosophila"
														value="citogenetica_y_sistemas_modelo_de_drosophila"
														onChange={
															onChangeGrupoInvestigacion
														}
													/>
			...
			<Modal
				...
				<Modal.Body>
					<div className="text-right">
						<button
							onClick={() => {
								...
								setTimeout(function () {
									$(
										'#biologia_molecular_y_biotecnologia_1'
									).prop('checked', false);
									$(
										'#biotecnologia_para_la_remediacion_1'
									).prop('checked', false);
									$(
										'#reproduccion_biologia_del_desarrollo_y_ecotoxicologia_1'
									).prop('checked', false);
									$(
										'#citogenetica_y_sistemas_modelo_de_drosophila_1'
									).prop('checked', false);
									for (
										var i = 0;
										i < gruposInvestigacion.length;
										i++
									) {
										j(
											'#' + gruposInvestigacion[i] + '_1'
										).prop('checked', true);
									}
								}, 50);
							}}
					...
					<div>
						<div className="text-center title-dark mb-4">
							Grupos de Investigación
						</div>
						<div className="grid-inputs-modal">
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="aplicacion_clinica_de_recursos_naturales"
									name="aplicacion_clinica_de_recursos_naturales"
									value="aplicacion_clinica_de_recursos_naturales"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="acuicultura_y_nutricion_de_organismos_acuaticos"
									name="acuicultura_y_nutricion_de_organismos_acuaticos"
									value="acuicultura_y_nutricion_de_organismos_acuaticos"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="biologia_ecologia_y_cultivo_hacia_el_aprovechamiento_sostenible_del_recurso_alga"
									name="biologia_ecologia_y_cultivo_hacia_el_aprovechamiento_sostenible_del_recurso_alga"
									value="biologia_ecologia_y_cultivo_hacia_el_aprovechamiento_sostenible_del_recurso_alga"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="biologia_molecular_y_biotecnologia"
									name="biologia_molecular_y_biotecnologia"
									value="biologia_molecular_y_biotecnologia"
									onChange={onChangeGrupoInvestigacion}
								/>
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="biologia_molecular_de_parasitos_y_de_recursos_pesqueros"
									name="biologia_molecular_de_parasitos_y_de_recursos_pesqueros"
									value="biologia_molecular_de_parasitos_y_de_recursos_pesqueros"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="biodiversidad_y_ecologia_de_ambientes_acuaticos_continentales"
									name="biodiversidad_y_ecologia_de_ambientes_acuaticos_continentales"
									value="biodiversidad_y_ecologia_de_ambientes_acuaticos_continentales"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="grupo_de_investigacion_en_bioeconomia"
									name="grupo_de_investigacion_en_bioeconomia"
									value="grupo_de_investigacion_en_bioeconomia"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="biodiversidad_de_ecosistemas_neotropicales"
									name="biodiversidad_de_ecosistemas_neotropicales"
									value="biodiversidad_de_ecosistemas_neotropicales"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="biotecnologia_para_la_remediacion"
									name="biotecnologia_para_la_remediacion"
									value="biotecnologia_para_la_remediacion"
									onChange={onChangeGrupoInvestigacion}
								/>
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="biodiversidad_y_taxonomia_de_invertebrados_marinos_para_conservacion_y_manejo_de_ambientes_marinos"
									name="biodiversidad_y_taxonomia_de_invertebrados_marinos_para_conservacion_y_manejo_de_ambientes_marinos"
									value="biodiversidad_y_taxonomia_de_invertebrados_marinos_para_conservacion_y_manejo_de_ambientes_marinos"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="reproduccion_biologia_del_desarrollo_y_ecotoxicologia"
									name="reproduccion_biologia_del_desarrollo_y_ecotoxicologia"
									value="reproduccion_biologia_del_desarrollo_y_ecotoxicologia"
									onChange={onChangeGrupoInvestigacion}
								/>
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="biotecnologia_reproductiva_para_la_conservacion_y_mejora_genetica_animal"
									name="biotecnologia_reproductiva_para_la_conservacion_y_mejora_genetica_animal"
									value="biotecnologia_reproductiva_para_la_conservacion_y_mejora_genetica_animal"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="calidad_biologica_y_fisico_quimica_de_alimentos_aguas_y_ambientes"
									name="calidad_biologica_y_fisico_quimica_de_alimentos_aguas_y_ambientes"
									value="calidad_biologica_y_fisico_quimica_de_alimentos_aguas_y_ambientes"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="citogenetica_y_sistemas_modelo_de_drosophila"
									name="citogenetica_y_sistemas_modelo_de_drosophila"
									value="citogenetica_y_sistemas_modelo_de_drosophila"
									onChange={onChangeGrupoInvestigacion}
								/>
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="delimitacion_de_la_biodiversidad_de_especies_y_macroevolucion"
									name="delimitacion_de_la_biodiversidad_de_especies_y_macroevolucion"
									value="delimitacion_de_la_biodiversidad_de_especies_y_macroevolucion"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="diversidad_de_mamiferos_y_sus_parasitos_y_su_implicancia_en_enfermedades_zoonoticas_emergentes"
									name="diversidad_de_mamiferos_y_sus_parasitos_y_su_implicancia_en_enfermedades_zoonoticas_emergentes"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="diversidad_sistematica_de_artropodos_neotropicales"
									name="diversidad_sistematica_de_artropodos_neotropicales"
									value="diversidad_sistematica_de_artropodos_neotropicales"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="grupo_de_investigacion_en_ecosistemas_marinos_y_costeros"
									name="grupo_de_investigacion_en_ecosistemas_marinos_y_costeros"
									value="grupo_de_investigacion_en_ecosistemas_marinos_y_costeros"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="ecologia_y_genetica_de_virus_emergentes_y_reemergentes"
									name="ecologia_y_genetica_de_virus_emergentes_y_reemergentes"
									value="ecologia_y_genetica_de_virus_emergentes_y_reemergentes"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="evolucion_molecular_de_la_biota_en_el_peru"
									name="evolucion_molecular_de_la_biota_en_el_peru"
									value="evolucion_molecular_de_la_biota_en_el_peru"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="estudio_de_las_poblaciones_amenazadas_de_la_flora"
									name="estudio_de_las_poblaciones_amenazadas_de_la_flora"
									value="estudio_de_las_poblaciones_amenazadas_de_la_flora"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="genes_cromosomas_y_genomas_de_mamiferos"
									name="genes_cromosomas_y_genomas_de_mamiferos"
									value="genes_cromosomas_y_genomas_de_mamiferos"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="genetica_de_enfermedades_metabolicas"
									name="genetica_de_enfermedades_metabolicas"
									value="genetica_de_enfermedades_metabolicas"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="grupo_de_investigacion_en_bioinformatica_y_biologia_estructural"
									name="grupo_de_investigacion_en_bioinformatica_y_biologia_estructural"
									value="grupo_de_investigacion_en_bioinformatica_y_biologia_estructural"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="genomica_funcional_de_microorganismos_y_biorremediacion"
									name="genomica_funcional_de_microorganismos_y_biorremediacion"
									value="genomica_funcional_de_microorganismos_y_biorremediacion"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="inmunomoduladores_y_antitumorales_de_origen_natural_y_sintetico"
									name="inmunomoduladores_y_antitumorales_de_origen_natural_y_sintetico"
									value="inmunomoduladores_y_antitumorales_de_origen_natural_y_sintetico"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="investigacion_y_desarrollo_de_procesos_biotecnologicos_agroindustriales_y_ambientales"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="grupo_de_investigacion_en_recursos_geneticos"
									name="grupo_de_investigacion_en_recursos_geneticos"
									value="grupo_de_investigacion_en_recursos_geneticos"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="recursos_naturales_y_bioactivos"
									name="recursos_naturales_y_bioactivos"
									value="recursos_naturales_y_bioactivos"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="restauracion_ecologica_de_ecosistemas_terrestres_y_acuaticas_del_peru"
									name="restauracion_ecologica_de_ecosistemas_terrestres_y_acuaticas_del_peru"
									value="restauracion_ecologica_de_ecosistemas_terrestres_y_acuaticas_del_peru"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="grupo_de_investigacion_en_toxinas_de_origen_animal_y_sus_antivenenos"
									name="grupo_de_investigacion_en_toxinas_de_origen_animal_y_sus_antivenenos"
									value="grupo_de_investigacion_en_toxinas_de_origen_animal_y_sus_antivenenos"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="inmunologia_parasitaria_en_humanos_y_animales_de_importancia_en_salud_publica"
									name="inmunologia_parasitaria_en_humanos_y_animales_de_importancia_en_salud_publica"
									value="inmunologia_parasitaria_en_humanos_y_animales_de_importancia_en_salud_publica"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									type="checkbox"
									id="virologia_clinica_molecular_inmunopatogenesis_y_antivirales"
									name="virologia_clinica_molecular_inmunopatogenesis_y_antivirales"
									value="virologia_clinica_molecular_inmunopatogenesis_y_antivirales"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label
									className="mb-0"
							...
							<div className="input-group mb-1">
								<input
									...
									id="biota_acuatica"
									name="biota_acuatica"
									value="biota_acuatica"
									onChange={onChangeGrupoInvestigacion}
								/>
								<label className="mb-0" for="biota_acuatica">
									<span className="checkmark"></span>Biota
									acuática
								</label>
							</div>
						</div>
