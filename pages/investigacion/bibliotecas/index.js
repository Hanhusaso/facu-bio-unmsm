        ...
        <>
            <Layout title="Bibliotecas">
                <div>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <Breadcrumb>
                                        ...
                                        <Breadcrumb.Item active>Investigación: Bibliotecas</Breadcrumb.Item>
                                    </Breadcrumb>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                    ...
                    <div>
                        <Container className="mb-3">
                            <Row>
                                <Col md="1"></Col>
                                <Col>
                                    <div className="title-page text-center">Bibliotecas</div>
                                </Col>
                                <Col md="1"></Col>
                            </Row>
                        </Container>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/investigacion/bibliotecas/biblioteca_banner.png" alt="" />
                    </div>
                            ...
                            <Row>
                                ...
                                <Col md="4" lg="6">
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-central" role="tabpanel" aria-labelledby="v-pills-central-tab">
                                            <div>
                                                <p>
                                                    La Biblioteca Central 'Pedro Zulen' de la Universidad Nacional Mayor de San Marcos, inaugurada en diciembre del año 1999, tiene como visión convertirse en un centro de información y modelo de biblioteca universitaria que brinde servicios de información innovadores a los usuarios internos y externos a través de una gestión basada en la optimización de recursos tecnológicos, económicos y humanos. Para ello, tiene como misión el ser un centro de recursos de información y difusión del conocimiento científico, tecnológico y humanístico que contribuya en la formación académico profesional y la investigación, brindando servicios de información pertinentes y de calidad, asumiendo el compromiso institucional de la Universidad, cuyos ejes están orientados al desarrollo humano y sostenible del país.
                                                </p>
                                                <div>
                                                    <p className="title-dark">Contacto:</p>
                                                    <div className="d-flex mb-2">
                                                        <div><img className="mr-3" src="/assets/img/iconos/lugar.svg" alt="" /></div>
                                                        <div>
                                                            <p>Av. Germán Amézaga Nº 375.</p>
                                                            <p>Edificio de Biblioteca Central Pedro Zulen</p>
                                                            <p>Ciudad Universitaria, Lima </p>
                                                        </div>
                                                    </div>
                                                    <div className="d-flex mb-2">
                                                        <div><img className="mr-3" src="/assets/img/iconos/telefono.svg" alt="" /></div>
                                                        <div>
                                                            <p>619-7000, anexo 7701</p>
                                                        </div>
                                                    </div>
                                                    <div className="d-flex mb-2">
                                                        <div><img className="mr-3" src="/assets/img/iconos/correo.svg" alt="" /></div>
                                                        <div>
                                                            <p>bibcent@unmsm.edu.pe</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p className="title-dark">Horario de atención: </p>
                                                    <div className="d-flex mb-2">
                                                        <div><img className="mr-3" src="/assets/img/iconos/reloj.svg" alt="" /></div>
                                                        <div>
                                                            <p>Lunes a Sábado 8:15 a.m. a 8:00 p.m.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
