							...
							<Row>
								...
								<Col md="4" lg="6">
									<div className="mb-3 tab-content" id="v-pills-tabContent">
										...
										>
											<p>
												De conformidad con la Ley 30220, artículo 57°.- El Consejo de Facultad es el
												órgano máximo de gobierno de la facultad.
											</p>
											...
											<p className="title-dark">Representación del tercio estudiantil</p>
											<ul className="chevron-green-dark">
											...
											<p className="title-dark">Autoridades</p>
											<ul className="chevron-green-dark">
												<li>
										...
										>
											<Tabs defaultActiveKey="2021" id="sesiones-tab">
												<Tab className="pt-3" eventKey="2021" title="2021">
													<div>
														<p className="title-dark">Sesión ordinaria</p>
														<ul className="chevron-green-dark">
															<li>
														...
														<p className="title-dark">Sesión extraordinaria</p>
														<ul className="chevron-green-dark">
															<li>
																<a href="#" className="color-inherit">
																	Sesión Ordinaria de Consejo del 27 de enero 2020
