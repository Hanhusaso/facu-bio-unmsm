        ...
        <>
            <Layout title="Consejo de facultad">
                <div>
                    ...
                    {/* IMAGE */}
                    <div className="mb-4">
                        <img className="w-100" src="/assets/img/nosotros/consejo/consejo_banner.png" alt="" />
                    </div>
                            ...
                            <Row>
                                ...
                                <Col md="3" lg="2">
                                    <div className="mb-4">
                                        <div className="nav flex-column tabs-wrapper nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                            {/* <li className="tab"> */}
                                                <a className="tab d-flex active" id="v-pills-miembros-tab" data-toggle="pill" href="#v-pills-miembros" role="tab" aria-controls="v-pills-miembros" aria-selected="true">
                                                    ...
                                                    <span>Miembros del consejo</span>
                                                </a>
                                            {/* </li> */}
                                            {/* <li className="tab"> */}
                                                <a className="tab d-flex" id="v-pills-comisiones-tab" data-toggle="pill" href="#v-pills-comisiones" role="tab" aria-controls="v-pills-comisiones" aria-selected="false">
                                                    <div>
                                                    ...
                                                    <span>Comisiones permanentes y transitorias</span>
                                                </a>
                                            {/* </li> */}
                                            {/* <li className="tab"> */}
                                                <a className="tab d-flex" id="v-pills-actas-tab" data-toggle="pill" href="#v-pills-actas" role="tab" aria-controls="v-pills-actas" aria-selected="false">
                                                    <div>
                                            ...
                                            {/* </li> */}
                                            {/* <li className="tab"> */}
                                                <a className="tab d-flex" id="v-pills-sesiones-tab" data-toggle="pill" href="#v-pills-sesiones" role="tab" aria-controls="v-pills-sesiones" aria-selected="false">
                                                    <div>
                                ...
                                <Col md="4" lg="6">
                                    <div className="mb-3 tab-content" id="v-pills-tabContent">
                                        <div className="mb-3 tab-pane fade show active" id="v-pills-miembros" role="tabpanel" aria-labelledby="v-pills-miembros-tab">
                                            <p>
                                        ...
                                        <div className="mb-3 tab-pane fade" id="v-pills-actas" role="tabpanel" aria-labelledby="v-pills-actas-tab">
                                        ...
                                        <div className="mb-3 tab-pane fade" id="v-pills-sesiones" role="tabpanel" aria-labelledby="v-pills-sesiones-tab">
