                                            ...
                                            <Container>
                                                <Row>
                                                    <Col md="9" className="pl-0">
                                                        ...
                                                        <div>
                                                            <a target="_blank" href="/assets/archivos/autoridades/decanos/RR/R.R. N.º 017245 - 2020.- DIRECTOR.pdf" className="d-block d-md-inline color-inherit mr-3 mb-3 mb-md-0">
                                                                <img className="mr-2" src="/assets/img/iconos/pdf.svg" alt=""/>
                                                                <span className="">Resolución rectoral</span>
                                                            </a>
                                                            <a target="_blank" href="/assets/archivos/autoridades/decanos/CV/cv-ramirez-roca.pdf" className="d-block d-md-inline color-inherit mr-3 mb-3 mb-md-0">
                                                                <img className="mr-2" src="/assets/img/iconos/pdf.svg" alt=""/>
                                                    ...
                                                    <Col md="3" className="pr-0">
                                                        ...
                                                        <div className="d-flex justify-content-center">
                                                            ...
                                                            <a className="btn-square-green mx-1" href="https://www.linkedin.com/in/pablo-sergio-ramirez-roca-2864a438/?originalSubdomain=pe" target="_blank">
                                            ...
                                            <Container>
                                                <Row>
                                                    <Col md="9" className="pl-0">
                                                        ...
                                                        <div>
                                                            <a target="_blank" href="/assets/archivos/autoridades/decanos/RR/R.R. N° 001841-2021-R VICEDECANA ACADÉMICA.pdf" className="d-block d-md-inline color-inherit mr-3 mb-3 mb-md-0">
                                                                <img className="mr-2" src="/assets/img/iconos/pdf.svg" alt=""/>
                                                                <span className="">Resolución rectoral</span>
                                                            </a>
                                                            <a target="_blank" href="/assets/archivos/autoridades/decanos/CV/CV_Ruth_Garcia_2020.pdf" className="d-block d-md-inline color-inherit mr-3 mb-3 mb-md-0">
                                                                <img className="mr-2" src="/assets/img/iconos/pdf.svg" alt=""/>
                                                                <span className="">Hoja de vida</span>
                                                            </a>
                                                        </div>
                                            ...
                                            <Container>
                                                <Row>
                                                    <Col md="9" className="pl-0">
                                                        ...
                                                        <div>
                                                            <a target="_blank" href="/assets/archivos/autoridades/decanos/RR/R.R. N° 001207-2021-R- VICEDECANA DE INVESTIGACIÓN Y POSGRADO.pdf" className="d-block d-md-inline color-inherit mr-3 mb-3 mb-md-0">
                                                                <img className="mr-2" src="/assets/img/iconos/pdf.svg" alt=""/>
                                                                <span className="">Resolución rectoral</span>
                                                            </a>
                                                            {/* <a target="_blank" href="/assets/archivos/autoridades/decanos/CV/" className="d-block d-md-inline color-inherit mr-3 mb-3 mb-md-0">
                                                                <img className="mr-2" src="/assets/img/iconos/pdf.svg" alt=""/>
                                                                <span className="">Hoja de vida</span>
                                                            </a> */}
                                                        </div>
