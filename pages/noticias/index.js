...
const noticias = () => {
	...
	const onChangeCategoria = (event) => {
		...
		if (encontrado) {
			setCategorias(categorias.filter((cat) => cat !== event.target.value));
			...
			if (palabra === "") {
				...
				setPaginador(
					<Pagination
						...
						totalPages={Math.ceil(response1 / 5.0)}
							...
							<Row>
										...
										<div className="">
											...
											<div>
												<div className="input-group mb-1">
													<input
														type="checkbox"
														id="categorias-campus"
														name="categorias-campus"
														value="Campus"
														onChange={onChangeCategoria}
													/>
													<label className="mb-0" for="categorias-campus">
														<span className="checkmark"></span> Campus y comunidad
													</label>
												</div>
												<div className="input-group mb-1">
													<input
														type="checkbox"
														id="categorias-arte"
														name="categorias-arte"
														value="Arte"
														onChange={onChangeCategoria}
													/>
													<label className="mb-0" for="categorias-arte">
														<span className="checkmark"></span> Arte, cultura y humanidades
													</label>
												</div>
												<div className="input-group mb-1">
													<input
														type="checkbox"
														id="categorias-ciencia"
														name="categorias-ciencia"
														value="Ciencia"
														onChange={onChangeCategoria}
													/>
													<label className="mb-0" for="categorias-ciencia">
														<span className="checkmark"></span> Ciencia, tecnología y salud
													</label>
												</div>
												{/* <div className="input-group mb-1">
													<input
														type="checkbox"
														id="categorias-negocios"
														name="categorias-negocios"
														value="4"
														onChange={onChangeCategoria}
													/>
													<label className="mb-0" for="categorias-negocios">
														<span className="checkmark"></span> Negocios, derecho y sociedad
													</label>
												</div> */}
												<div className="input-group mb-1">
													<input
														type="checkbox"
														id="categorias-investigacion"
														name="categorias-investigacion"
														value="Investigacion"
														onChange={onChangeCategoria}
													/>
													<label className="mb-0" for="categorias-investigacion">
														<span className="checkmark"></span> Investigación
													</label>
												</div>
												{/* <div className="input-group mb-1">
													<input
														type="checkbox"
														id="categorias-comunicados"
														name="categorias-comunicados"
														value="Comunicados"
														onChange={onChangeCategoria}
													/>
													<label className="mb-0" for="categorias-comunicados">
														<span className="checkmark"></span> Comunicados
													</label>
												</div> */}
												{/* <div className="input-group mb-1">
													<input
														type="checkbox"
														id="categorias-articulos"
														name="categorias-articulos"
														value="Articulos"
														onChange={onChangeCategoria}
													/>
													<label className="mb-0" for="categorias-articulos">
														<span className="checkmark"></span> Artículos de opinión
													</label>
												</div> */}
												{/* <div className="input-group mb-1">
													<input
														type="checkbox"
														id="categorias-editoriales"
														name="categorias-editoriales"
														value="Editoriales"
														onChange={onChangeCategoria}
													/>
													<label className="mb-0" for="categorias-editoriales">
														<span className="checkmark"></span> Editoriales
													</label>
												</div> */}
											</div>
										</div>
								...
								<Col md="7" lg="8">
									{loading ? (
										...
										<div>
											<div className="mb-2">
												{countNoticias} {countNoticias == 1 ? "resultado" : "resultados"}
											</div>
												...
												<div key={index}>
													<div className="grid-img-txt-2 no-reverse">
														<a
															...
															href={`noticias/noticia?titulo=${noticia.slug}`}
														>
															<div className="part-img position-relative">
																<img
																	className="w-100 img-fluid"
																	src={noticia.banner.formats.thumbnail.url || ""}
																	alt=""
																/>
																<div className="badge-tag">
																	{noticia.sub_categoria_noticia.nombre}
																</div>
															</div>
														</a>
														<div>
															<p className="mb-1 date">
																...
																<span>
																	{new Date(noticia.fecha).getDate()} de{" "}
																	{months[new Date(noticia.fecha).getMonth()]} de{" "}
																	{new Date(noticia.fecha).getFullYear()}
																</span>
															</p>
															<a
																href={`noticias/noticia?titulo=${noticia.slug}`}
																className="mb-1 title line-clamp-2"
															>
																{noticia?.titulo}
															</a>
															<p className="mb-0 line-clamp-4">{noticia?.sintesis}</p>
														</div>
													</div>
